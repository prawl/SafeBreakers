...
//		,EndOfLoopSkipBreaks
	...
	public class AnimationProgressionVariables
	{
		...
		public int m_letter_value_inc_white_space;		// The letter index, with white space chars counted as well
	...
	public static class TextFxHelperMethods
	{
		...
		public static Vector3 JSONtoVector3 (this Boomlagoon.JSON.JSONObject json_data)
		{
			return new Vector3() {
