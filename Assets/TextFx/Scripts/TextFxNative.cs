...
namespace TextFx
{
	...
	public class TextFxNative : MonoBehaviour, TextFxAnimationInterface
	{
		...
		void Update()
		{
			...
			UpdateTextFxMesh (m_animation_manager.MeshVerts != null ? m_animation_manager.MeshVerts : m_mesh_verts,
			                  m_animation_manager.MeshColours != null ? m_animation_manager.MeshColours : m_mesh_cols);
		}
...
#pragma warning restore				
		...
		public void SetText(string new_text)
		{
			...
			UpdateMesh(m_mesh_verts, m_mesh_cols);
		}
		...
		void UpdateMesh(Vector3[] mesh_verts, Color[] mesh_cols)
		{
			if (m_mesh_uvs == null)
			{
				//
